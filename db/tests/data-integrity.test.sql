...
CREATE FUNCTION pg_temp.upsert_finding(p_run uuid) RETURNS void LANGUAGE sql AS $f$
  WITH x AS (
    INSERT INTO mux_drift_findings (kind, mux_asset_id, recording_id, previous_status, first_detected_run_id, last_detected_run_id)
    VALUES ('DB_ROW_WITHOUT_MUX_ASSET', 'test-gone', 'e0000000-0000-0000-0000-000000000001', 'ready', p_run, p_run)
