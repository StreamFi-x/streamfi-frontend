...
BEGIN
  ...
  LOOP
    IF to_regclass(format('%I', target.tbl)) IS NULL THEN
      CONTINUE;
    END IF;
    ...
    FOR fk IN
      ...
      WHERE con.contype = 'f'
        AND con.conrelid = format('%I', target.tbl)::regclass
    ...
    LOOP
      ...
      EXECUTE format(
        'ALTER TABLE %I ADD CONSTRAINT %I FOREIGN KEY (%I) REFERENCES users(id) ON DELETE RESTRICT NOT VALID',
