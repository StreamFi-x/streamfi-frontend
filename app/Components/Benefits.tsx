...
export const Benefits = () => {
  return (
    <section className="relative  mt-14 px-6 md:px-12 lg:px-24 py-16 text-white">
      <div className="mb-12">
      ...
      <div className="grid grid-cols-3 grid-rows-4 gap-6">
        <div
          className="col-span-2 row-span-2 p-6 rounded-lg h-[380px] flex flex-col justify-between"
          style={{
            background:
        ...
        {/* Ad-Free Experience */}
        <div
          className="row-span-2 col-start-3 p-6 rounded-lg h-[380px] flex flex-col justify-between"
          style={{
            background:
        ...
        >
          <div className="leading-relaxed mt-auto">
            <div className="flex items-center gap-4 mb-4">
              <h3 className="text-4xl font-semibold">Ad-Free Experience</h3>
            </div>
            <p className="text-gray-300 text-base">
        ...
        <div
          className="row-span-2 row-start-3 p-6 rounded-lg h-[380px] flex flex-col justify-between"
          style={{
            background:
              "linear-gradient(291.43deg, #16062B 24.87%, #15375B 137.87%)",
          }}
        ...
        <div
          className="col-span-2 row-span-2 row-start-3 p-6 rounded-lg h-[380px] flex flex-col justify-between"
          style={{
            background:
              "linear-gradient(291.43deg, #16062B 24.87%, #15375B 137.87%)",
          }}
