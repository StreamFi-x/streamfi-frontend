...
// as a "C..." contract address, standing in for the deployed subscription contract.
...
export const tierPrices: Record<string, TierPrice> = {
  tier_alpha_basic: { tier_id: "tier_alpha_basic", name: "Basic", price_usdc: 5 },
  tier_alpha_premium: {
    tier_id: "tier_alpha_premium",
    name: "Premium",
    price_usdc: 15,
  },
  tier_beta_basic: { tier_id: "tier_beta_basic", name: "Supporter", price_usdc: 8 },
};
