...
describe("/api/routes-f/quote", () => {
  ...
  describe("GET /quote/[id]", () => {
    it("should return quote by valid ID", async () => {
      ...
      const request = new NextRequest(
        "http://localhost:3000/api/routes-f/quote/1"
      );
    ...
    it("should return 404 for non-existent quote ID", async () => {
      ...
      const request = new NextRequest(
        "http://localhost:3000/api/routes-f/quote/999"
      );
    ...
    it("should return 400 for invalid quote ID format", async () => {
      const request = new NextRequest(
        "http://localhost:3000/api/routes-f/quote/invalid"
      );
  ...
  describe("GET /quote/today", () => {
    it("should return deterministic quote for given date", async () => {
      ...
      const request = new NextRequest(
        "http://localhost:3000/api/routes-f/quote/today?date=2024-01-01"
      );
    ...
    it("should return deterministic quote for today when no date provided", async () => {
      ...
      const request = new NextRequest(
        "http://localhost:3000/api/routes-f/quote/today"
      );
      const response = await GET(request);
      const data = await response.json();
    ...
    it("should return 400 for invalid date format", async () => {
      const request = new NextRequest(
        "http://localhost:3000/api/routes-f/quote/today?date=invalid"
      );
      const response = await GET(request);
      const data = await response.json();
  ...
  describe("GET /quote/random", () => {
    it("should return random quote", async () => {
      ...
      const request = new NextRequest(
        "http://localhost:3000/api/routes-f/quote/random"
      );
      const response = await GET(request);
      const data = await response.json();
    ...
    it("should return random quote from specific category", async () => {
      ...
      const request = new NextRequest(
        "http://localhost:3000/api/routes-f/quote/random?category=technology"
      );
      const response = await GET(request);
      const data = await response.json();
    ...
    it("should return 400 for invalid category", async () => {
      ...
      const request = new NextRequest(
        "http://localhost:3000/api/routes-f/quote/random?category=invalid"
      );
      const response = await GET(request);
      const data = await response.json();
  ...
  describe("GET /quote (list all)", () => {
    it("should return all quotes", async () => {
      const request = new NextRequest(
        "http://localhost:3000/api/routes-f/quote"
      );
      const response = await GET(request);
      const data = await response.json();
