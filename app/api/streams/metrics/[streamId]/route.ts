 ...
 * 
 * API endpoint for deleting/deactivating streams
 * Removes Livepeer stream and clears stream data from user record
 * Maintains stream session history for analytics
 */
