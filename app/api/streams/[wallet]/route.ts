 ...
 * 
 * API endpoint for fetching comprehensive stream data by wallet address
 * Returns user info, stream configuration, live status, and session metrics
 * Includes Livepeer health data for active streams
 */
...
export async function GET(
  ...
  try {
    ...
    // If user has a stream, get additional health data from Livepeer
