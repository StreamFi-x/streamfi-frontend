...
export default function StreamAccessSettings({
  ...
  useEffect(() => {
    if (initialAccessType) {
      setAccessType(initialAccessType);
    }
    if (initialAccessConfig) {
      setConfig(initialAccessConfig);
    }
            ...
            <div className="space-y-2 animate-in fade-in slide-in-from-top-2 duration-300">
              ...
              <div className="relative group">
                <input
                  ...
                  onChange={e =>
                    setConfig({ ...config, price_usdc: e.target.value })
                  }
                  placeholder="10.00"
            ...
            <div className="space-y-4 animate-in fade-in slide-in-from-top-2 duration-300 bg-secondary/20 p-3 rounded-xl border border-border/50 shadow-inner">
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    onChange={e =>
                      setConfig({ ...config, asset_code: e.target.value })
                    }
                    placeholder="USDC"
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    onChange={e =>
                      setConfig({ ...config, min_balance: e.target.value })
                    }
                    placeholder="1.00"
                    className="w-full bg-secondary/50 border border-border rounded-xl px-3 py-2.5 text-xs focus:outline-none focus:ring-2 focus:ring-highlight/20 focus:border-highlight transition-all"
                  />
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  onChange={e =>
                    setConfig({ ...config, asset_issuer: e.target.value })
                  }
                  placeholder="G..."
