...
export const Button = ({
  ...
  // Base button styles
  const baseStyles =
    "font-medium rounded-md text-base transition-all duration-200 flex items-center justify-center";

  const variantStyles = {
    default:
      "bg-primary text-white hover:bg-purple-700 focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-black",
    outline:
    ...
    link: "bg-transparent text-purple-600 hover:underline p-0 h-auto",
    destructive:
