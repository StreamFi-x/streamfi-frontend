...
export default function Sidebar({ isOpen = true, onClose }: SidebarProps) {
  ...
  const renderExpandedContent = () => (
    ...
    >
      <div className="flex justify-between items-center w-full mb-4 px-[1em]">
        ...
        <motion.button 
          variants={itemVariants}
          className="text-white p-1 hover:bg-[#2D2F31]/60 rounded-full transition-colors duration-200 button-spring no-flicker"
            ...
            >
              <Link
                ...
                className={`flex items-center gap-3 p-3 rounded-md transition-all duration-200 ${
                  isActive
                    ? "bg-[#2D2F31] text-white shadow-lg"
      ...
      <motion.hr 
        variants={itemVariants}
        className="bg-white/10 my-4 border-t border-white/10" 
      />
      <motion.div variants={itemVariants}>
        ...
        <div className="space-y-1">
          {recommendedUsers.map((user, index) => (
            ...
            >
              <Link
                href="#"
                className="flex items-center gap-3 px-2 py-2 rounded-md hover:bg-[#2D2F31]/60 transition-colors duration-200"
              >
        ...
        <motion.button 
          variants={itemVariants}
          className="w-full mt-3 text-sm text-white bg-[#2D2F31]/60 hover:bg-[#2D2F31] rounded-md py-2.5 text-center transition-colors duration-200"
        >
          See more
        </motion.button>
      </motion.div>
  ...
  const renderCollapsedContent = () => (
    ...
    >
      ...
      <motion.nav variants={itemVariants} className="flex flex-col gap-3 items-center">
        {navItems.map((item, index) => {
          const isActive = isRouteActive(item.href);
          return (
            <motion.div
  ...
  return (
    <>
      <motion.div
        className="hidden lg:block bg-[#17191A] flex-shrink-0 relative overflow-hidden sidebar-container sidebar-animated"
