...
export function TipCounter({
    ...
    const totalCount = typeof stats.totalCount === 'number' ? stats.totalCount : parseInt(stats.totalCount?.toString() || '0');
    const isZero = totalCount === 0 && parseFloat(stats.totalReceived) === 0;
