...
const mockChatMessages = [
  { id: 1, username: "Wagner", message: "First viewer joining in today", color: "#9333ea" },
  { id: 2, username: "Wolf", message: "Wait crates ?", color: "#10b981" },
  { id: 3, username: "Wagner", message: "First viewer joining in today", color: "#9333ea" },
  { id: 4, username: "Cleo", message: "Nyo in epi biko", color: "#f59e0b" },
  { id: 5, username: "Cleo", message: "Nyo in epi biko", color: "#f59e0b" },
  { id: 6, username: "Spencer Smith", message: "what game are we streaming today ?", color: "#ef4444" },
  { id: 7, username: "Wagner", message: "First viewer joining in today", color: "#9333ea" },
  { id: 8, username: "Hack", message: "Send Funds here: 0x0d7f7a8d9a7f8d9a7f8d9a7f8d9a7f8d9a7f8d9a", color: "#3b82f6" },
  { id: 9, username: "Spencer Smith", message: "what game are we streaming today ?", color: "#ef4444" },
  { id: 10, username: "Spencer Smith", message: "what game are we streaming today ?", color: "#ef4444" },
  { id: 11, username: "Spencer Smith", message: "what game are we streaming today ?", color: "#ef4444" },
  { id: 12, username: "Wagner", message: "First viewer joining in today", color: "#9333ea" },
]

const ViewStream = ({ username, isLive: initialIsLive, onStatusChange, isOwner = false }: ViewStreamProps) => {
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div ref={videoContainerRef} className="relative bg-black aspect-video">
            {isLive ? (
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-white text-center">
                  <div className="bg-red-600 text-white text-xs px-2 py-1 rounded-sm inline-block mb-4">Live</div>
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-gray-900">
                <div className="text-white text-center">
                  ...
                  <p className="text-sm text-gray-400">Check back later or browse past streams below</p>
                </div>
              </div>
            )}
            ...
            <div className="absolute bottom-0 left-0 right-0 flex items-center justify-between p-4 bg-gradient-to-t from-black/80 to-transparent">
              <div className="flex items-center space-x-4">
                ...
                <span className="text-white text-xs">{streamData.duration}</span>
              </div>
              <div className="flex items-center space-x-2">
                <button className="text-white" onClick={toggleChat} aria-label={showChat ? "Hide chat" : "Show chat"}>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                <div className="relative w-12 h-12 rounded-full overflow-hidden bg-purple-600">
                  <Image
                    src={streamData.avatarUrl || "/placeholder.svg?height=48&width=48"}
                    alt={username}
                    fill
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-1">
                    {streamData.tags.map((tag: string) => (
                      <span key={tag} className="text-xs bg-[#2D2F31] text-gray-300 px-2 py-0.5 rounded">
                        {tag}
                      </span>
                    ))}
                  </div>
              ...
              <div className="flex items-center space-x-2">
                {isOwner ? (
                  ...
                  <>
                    ...
                    <Button variant="outline" className="bg-[#2D2F31] hover:bg-[#3D3F41] text-white border-gray-600">
          ...
          <div className="p-4 border-b border-gray-800">
            ...
            <p className="text-gray-300 text-sm line-clamp-2">{streamData.bio}</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="bg-[#2D2F31] rounded-md overflow-hidden">
                <div className="aspect-video relative">
                  <Image src="/placeholder.svg?height=180&width=320" alt="Past stream" fill className="object-cover" />
                </div>
                <div className="p-3">
                  <h4 className="text-white text-sm font-medium truncate">Previous Stream Highlight</h4>
                  <p className="text-gray-400 text-xs mt-1">2 days ago • 45K views</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {showChat && (
          <div className="w-80 border-l border-gray-800 flex flex-col">
            <div className="p-3 border-b border-gray-800 flex justify-between items-center">
              ...
              <button onClick={toggleChat} className="text-gray-400 hover:text-white" aria-label="Hide chat">
            ...
            <div className="p-3 border-t border-gray-800">
              <div className="relative">
                ...
                <div className="absolute right-2 top-2 flex space-x-1">
                  ...
                  <button className="text-gray-400 hover:text-white" onClick={sendChatMessage}>
