...
export const buttonClasses = {
  primary: `bg-purple-600 hover:bg-purple-700 text-white dark:text-gray-900  ${themeTransition}`,
...
export const shadowClasses = {
  default: "shadow-sm dark:shadow-lg", // Subtle shadow
  md: "shadow-md dark:shadow-xl", // Medium shadow
  xl: "shadow-xl dark:shadow-2xl", // Extra large shadow for toasts
};
